...
private JMenuItem MI_ShowCellHeatRanking;
private JMenuItem MI_ShowCacheWarmupCmd;
private JMenuItem MI_ShowCacheBlocks;
//private JMenuItem MI_ShowHitMiss;
...
*/
   ...
   MI_ShowCellHeatRanking = HelpMenu.add("Show 3D Cell Heat Ranking");
   MI_ShowCacheWarmupCmd = HelpMenu.add("Generate Cache Warm-up Commands");
   MI_ShowCacheBlocks = HelpMenu.add("Change of Cache Blocks");
   //MI_ShowHitMiss = HelpMenu.add("Show Cache Hit/Miss Blocks");
   ...
   MI_ShowCellHeatRanking.addActionListener(new ActionListener(){
              public void actionPerformed(ActionEvent evt){
                  MyHelp.setMode(HelpScreen.CELLHEATRANKING);
                  MyHelp.setVisible(true);
              }
           });

   MI_ShowCacheWarmupCmd.addActionListener(new ActionListener(){
          public void actionPerformed(ActionEvent evt){
              MyHelp.setMode(HelpScreen.CACHEWARMUPCMD);
              MyHelp.setVisible(true);
          }
       });
   MI_ShowCacheBlocks.addActionListener(new ActionListener(){
             public void actionPerformed(ActionEvent evt){
                 MyHelp.setMode(HelpScreen.CACHEBLOCKS);
                 MyHelp.setVisible(true);
             }
          });
//    MI_ShowCacheBlocks.addActionListener(new ActionListener(){
//                 public void actionPerformed(ActionEvent evt){
//                     MyHelp.setMode(HelpScreen.HITMISS);
//                     MyHelp.setVisible(true);
//                 }
//              });
